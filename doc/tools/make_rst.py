...
# Import hardcoded version information (from version.gen.py if present, else version.py)
...
def make_rst_class(class_def: ClassDef, state: State, dry_run: bool, output_dir: str) -> None:
    ...
    with open(
        ...
        source_github_url = f"https://github.com/tekisasuengine/tekisasu/tree/{git_branch}/{source_xml_path}"
        generator_github_url = f"https://github.com/tekisasuengine/tekisasu/tree/{git_branch}/doc/tools/make_rst.py"

        f.write(".. DO NOT EDIT THIS FILE!!!\n")
        f.write(".. Generated automatically from Tekisasu Engine sources.\n")
