...
if (
    ...
    print("FATAL ERROR: Tekisasu Engine has been crashed.")
    sys.exit(52)

# Finding memory leaks in Tekisasu is quite difficult, because we need to take into
...
# It may happen that Tekisasu detects leaking nodes/resources and removes them, so
...
# For now Tekisasu leaks a lot of rendering stuff so for now we just show info
